...
Flight::register('db', 'PDO', array("sqlsrv:server = tcp:apipiainterfaces-server.database.windows.net,1433; Database = apipiainterfaces-database", "apipiainterfaces-server-admin", "{3WV3E770P38Z82E7$}"), function($db){
